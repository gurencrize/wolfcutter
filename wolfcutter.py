...
def button3():#線の設定を上書きするための関数。tateとyokoを変えると好きな本数線を引けてすごい
  tate=0
  yoko=0
  sptxt1.set(tate)
  sptxt2.set(yoko)
  redrawline()
button3=ttk.Button(frame1,text="リセット",command=button3)
...
button4=ttk.Button(frame1,text="保存先フォルダ選択",command=button4)
button4.grid(row=2,column=2)

def button5():
  image.imgtrim()
button5=ttk.Button(frame1,text="連番出力",command=button5)
